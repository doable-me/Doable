...
function LandingPagePreview() {
  return (
    <div className="flex h-full w-full flex-col overflow-hidden rounded-t-xl bg-gradient-to-b from-orange-950 to-slate-900">
      {/* Nav */}
      <div className="flex items-center justify-between px-4 py-2.5">
        <div className="flex items-center gap-1.5">
          <div className="h-4 w-4 rounded bg-orange-500/60" />
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="h-4 w-14 rounded-full bg-orange-500/50" />
        </div>
      </div>
      {/* Hero */}
      <div className="flex flex-1 flex-col items-center justify-center px-6 text-center">
        <div className="mb-2 h-3 w-24 rounded-full bg-orange-500/20 border border-orange-500/30" />
        ...
        <div className="flex gap-2">
          <div className="h-5 w-18 rounded-full bg-orange-500/60" />
      ...
      <div className="grid grid-cols-3 gap-2 px-4 pb-3">
        {[1, 2, 3].map((i) => (
          ...
          >
            <div className="mb-1.5 h-4 w-4 rounded bg-orange-500/30" />
  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 w-full overflow-hidden">
        ...
        {/* Official badge */}
        {template.isOfficial && (
          <div className="absolute right-2 top-2 flex items-center gap-1 rounded-full bg-black/70 backdrop-blur-sm border border-orange-500/30 px-2 py-0.5">
