        ...
        <div className="mx-3 mb-4 rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-56 bg-zinc-900 border-zinc-800">
              ...
              {workspaces.map((ws) => (
                ...
                >
                  <div className="flex h-5 w-5 items-center justify-center rounded bg-brand-600/20 text-xs font-semibold text-brand-400">
          ...
          <div className="space-y-1">
            ...
            <div className="h-1.5 w-full rounded-full bg-zinc-800">
              <div
                className="h-1.5 rounded-full bg-gradient-to-r from-brand-600 to-brand-500 transition-all"
        ...
        <nav className="flex-1 overflow-y-auto px-2">
          ...
          <div className="space-y-0.5">
            ...
            <NavItem
              ...
              onClick={() => emitDashboardEvent(DASHBOARD_EVENTS.IMPORT_GITHUB)}
            />
          </div>
          ...
          {workspacePlan === "free" && (
            <div className="rounded-lg bg-gradient-to-br from-brand-600/20 to-brand-600/10 border border-brand-500/20 p-3">
              ...
              <button
                ...
                className="w-full rounded-md bg-brand-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-brand-500 transition-colors"
              >
                Upgrade now
              </button>
            </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex w-full items-center gap-3 rounded-lg px-2 py-2 hover:bg-white/5 transition-colors outline-none">
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-gradient-to-br from-brand-500 to-brand-600 text-xs font-medium text-white">
                  {initials}
                </AvatarFallback>
              </Avatar>
