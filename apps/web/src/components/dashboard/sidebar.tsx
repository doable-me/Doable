...
import {
  ...
  ChevronsUpDown, Plus, Loader2, Shield, Compass, LayoutTemplate, Store, BarChart3, Server, Package,
} from "lucide-react";
      ...
      <aside className="flex h-full w-[260px] shrink-0 flex-col border-r border-border bg-background">
        ...
        <nav className="flex-1 overflow-y-auto px-2">
          <div className="space-y-0.5">
            ...
            <NavItem icon={Package} label="Environments" active={pathname.startsWith("/workspace-settings")} onClick={() => { router.push("/workspace-settings?tab=environments"); onNavigate?.(); }} />
