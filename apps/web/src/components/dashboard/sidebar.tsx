    ...
    <>
      <aside className="flex h-screen w-[260px] shrink-0 flex-col border-r border-zinc-800 bg-[#0a0a0a]">
        ...
        <a href="/dashboard" className="flex items-center gap-2.5 px-5 pt-5 pb-4 hover:opacity-80 transition-opacity cursor-pointer">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-orange-600 to-orange-700 shadow-sm shadow-orange-900/30">
        ...
        <div className="mx-3 mb-4 rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-56 bg-zinc-900 border-zinc-800">
              ...
              {workspaces.map((ws) => (
                ...
                >
                  <div className="flex h-5 w-5 items-center justify-center rounded bg-orange-600/20 text-xs font-semibold text-orange-400">
                    {ws.name.charAt(0).toUpperCase()}
                  </div>
                  <span className="ml-2 flex-1 truncate">{ws.name}</span>
                  {ws.id === activeWorkspaceId && (
                    <Check className="ml-auto h-3.5 w-3.5 text-orange-400" />
                  )}
                </DropdownMenuItem>
              ))}
            </DropdownMenuContent>
          ...
          <div className="space-y-1">
            ...
            <div className="h-1.5 w-full rounded-full bg-zinc-800">
              <div
                className="h-1.5 rounded-full bg-gradient-to-r from-orange-600 to-orange-500 transition-all"
        ...
        <nav className="flex-1 overflow-y-auto px-2">
          ...
          <div className="space-y-0.5">
            <div
              ...
              className={allProjectsDragOver ? "rounded-lg ring-1 ring-orange-500/40 bg-orange-500/10" : ""}
            >
              <NavItem
                icon={FolderOpen}
                label="All projects"
        ...
        <div className="mt-auto border-t border-zinc-800 p-3 space-y-3">
          {/* Upgrade Card */}
          {workspacePlan === "free" && (
            <div className="rounded-lg bg-gradient-to-br from-orange-600/20 to-orange-600/10 border border-orange-500/20 p-3">
              ...
              <button
                ...
                className="w-full rounded-md bg-orange-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-orange-500 transition-colors"
              >
                Upgrade now
              </button>
            </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex w-full items-center gap-3 rounded-lg px-2 py-2 hover:bg-white/5 transition-colors outline-none">
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-gradient-to-br from-orange-500 to-orange-600 text-xs font-medium text-white">
                  {initials}
                </AvatarFallback>
              </Avatar>
