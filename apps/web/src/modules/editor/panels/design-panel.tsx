        ...
        {!selectedElement && (
          <div className="flex flex-col items-center px-6 pt-12">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-zinc-800/60">
              {mode === "selecting" ? (
                <Crosshair className="h-6 w-6 text-orange-400 animate-pulse" />
              ) : (
            ...
            {mode === "idle" && (
              <button
                onClick={onActivate}
                className="flex items-center gap-2 rounded-lg bg-orange-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-orange-500 transition-colors shadow-md shadow-orange-900/30"
              >
              ...
              <div className="sticky bottom-0 border-t border-zinc-800/60 bg-[#1C1C1C] px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={isSaving}
                    className="flex items-center justify-center gap-2 rounded-lg bg-orange-600/80 px-3 py-2 text-xs font-medium text-white hover:bg-orange-500 transition-all disabled:opacity-50"
        ...
        <div className="mb-2 flex items-center gap-1.5">
          ...
          {selectedElement && (
            <>
              ...
              <span className="flex items-center gap-1 rounded-md bg-orange-500/15 px-2 py-1 text-[11px] font-medium text-orange-300">
