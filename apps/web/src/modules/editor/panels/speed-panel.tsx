                      ...
                      {isExpanded && (
                        <div className="px-3 pb-3 pt-0 border-t border-zinc-800/40">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 rounded-md bg-orange-600/20 border border-orange-500/30 px-3 py-1.5 text-[11px] font-medium text-orange-300 hover:bg-orange-600/30 transition-colors"
                          >
