  ...
  return (
    <div className="flex flex-col items-center gap-0.5">
      ...
      <input
        ...
        title={label}
        className="w-full rounded border border-zinc-700/60 bg-zinc-800/80 px-1 py-1 text-center text-[11px] text-zinc-300 outline-none font-mono focus:border-orange-500/50 transition-colors"
      />
    </div>
  );
}
