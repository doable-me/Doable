    ...
    <div className="flex h-full flex-col border-l border-border bg-[#1e1e1e]">
      ...
      {readOnly && (
        <div className="flex items-center gap-2 border-b border-amber-800/30 bg-amber-950/20 px-3 py-1.5">
          ...
          <button className="ml-auto flex items-center gap-1 rounded-md bg-orange-600 px-2 py-0.5 text-[11px] font-medium text-white hover:bg-orange-500 transition-colors">
