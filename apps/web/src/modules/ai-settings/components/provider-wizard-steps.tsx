  ...
  return (
    <div className="space-y-4">
      ...
      {isAzure && preset.baseUrlTemplate && (
        <div>
          <label className="mb-1.5 block text-xs font-medium text-zinc-400">Azure Resource Name</label>
          <input
            type="text"
      ...
      {isAzure && (
        <div>
          <label className="mb-1.5 block text-xs font-medium text-zinc-400">API Version</label>
          <input
            type="text"
