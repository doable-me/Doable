...
**Date:** 2026-05-10
**Test:** TC-WS-CRUD-032 on https://zantaz-api.doable.me

## Steps to reproduce
```
TOK=<qa-owner access token>
curl -i -H "Authorization: Bearer $TOK" \
  https://zantaz-api.doable.me/workspaces/not-a-uuid
```
...
## Repro evidence
- Body file: `testcases/evidence/zantaz-ws/TC-WS-CRUD-032.body`
- Header file: `testcases/evidence/zantaz-ws/TC-WS-CRUD-032.hdr`
