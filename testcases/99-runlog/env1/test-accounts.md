# Test Accounts (mirrored from staging on 2026-05-10)

All passwords: `TestPass123!`  ·  Tokens cached at `testcases/evidence/_tokens-env1.json`
...
- WS: wss://<env>-ws.doable.me
- Web: https://<env>.doable.me

## Stripe bypass
All `credit_balances` rows for qa-* users seeded with daily=100k, monthly=1M, rollover=1M, plan_type=enterprise. `STRIPE_SECRET_KEY` empty in target environment .env (Stripe-dependent tests will be marked BLOCKED with stripe reason).
