      ...
      <div className="flex gap-1">
        {pieces.length > 0 ? (
          pieces.map((piece, i) => (
            <span
              key={i}
              className={`text-xl ${piece.isWhite ? "text-white drop-shadow-md" : "text-stone-900"}`}
              style={{
          ...
          <span className="text-stone-600 text-sm italic">None</span>
        )}
      </div>
    </div>
  );
...
function ChessBoard() {
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="flex flex-col gap-1 px-2 py-3 bg-stone-800/50 rounded-lg min-w-[300px]">
