...
| `POST /auth/mfa/enroll/start` | 4 | 14 | qa-owner/empty → 500 (expected 200|400|409); qa-owner/empty → 500 (expected 400|401|415|422); qa-owner/invalid-shape → 500 (expected 400|401|415|422) |
