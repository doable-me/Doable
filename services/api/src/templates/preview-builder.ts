...
function landingPagePreview(): string {
  return `
  <!-- Navbar -->
...
function saasDashboardPreview(): string {
  return `
...
function ecommercePreview(): string {
  return `
  <!-- Nav -->
...
function portfolioPreview(): string {
  return `
  <!-- Nav -->
  <header class="border-b bg-white">
...
function todoAppPreview(): string {
  return `
...
function blankPreview(template: TemplateDefinition): string {
  return `
