...
// ─── AI, ML & Automation Integrations ───────────────────
//
// Curated definitions for AI/ML providers, speech/audio,
// image/video generation, AI tools, and automation
// integrations backed by Activepieces pieces.
// OpenAI is intentionally omitted — it lives in the main registry.
